  ...
  experienceData: [
    {
      ...
      details: [
        ...
        "Analyze system failure patterns and create documentation to help development teams resolve recurring issues.",
      ],
    ...
    },
    {
      ...
      details: [
        ...
        "Maintained code quality standards and followed project management best practices.",
      ],
